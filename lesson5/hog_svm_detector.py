# https://vovkos.github.io/doxyrest-showcase/opencv/sphinx_rtd_theme/group_objdetect.html?highlight=hogdescriptor
...
def detectByPathVideo(path, writer):
    ...
    while video.isOpened():
        ...
        if check:
            ...
            frame = detect(frame)  # main detect function
...
def detectByPathImage(path, output_path):
    ...
    result_image = detect(image)  # main detect function
